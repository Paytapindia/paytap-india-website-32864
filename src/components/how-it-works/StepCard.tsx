    ...
    <div className="relative flex flex-col items-center w-full max-w-xs md:max-w-sm">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300 h-full w-full">
        ...
        <div className="flex justify-center mb-3 md:mb-4">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-paytap-dark rounded-full flex items-center justify-center text-white font-bold text-base md:text-lg shadow-lg">
            {step.id}
          </div>
        </div>
        
        {/* Visual content - mobile optimized */}
        <div className={`w-full h-24 md:h-32 bg-gradient-to-br ${step.bgColor} rounded-xl flex items-center justify-center mb-3 md:mb-4 border border-paytap-gray`}>
      ...
      {!isLast && (
        <div className="flex justify-center my-3 md:hidden">
          <div className="flex flex-col items-center">
            <div className="w-0.5 h-4 bg-paytap-light/50"></div>
            <ChevronDown className="w-4 h-4 text-paytap-light" />
          </div>
        </div>
      )}
    </div>
