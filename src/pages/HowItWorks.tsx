...
const HowItWorks = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      subtitle: "2 vehicles",
      price: "₹1,600",
      features: ["2 Prepaid Tags free", "Paytap Dashboard", "Tag Control", "Transaction View"],
      highlighted: false,
    },
    {
      name: "Business Pro",
      subtitle: "5 vehicles",
      price: "₹3,749",
      features: ["5 Prepaid Tags free", "1 Driver Expense Card", "Dedicated Support", "Myfleet AI", "ExpensePro"],
      highlighted: true,
    },
    {
      name: "Corporate",
