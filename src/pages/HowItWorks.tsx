...
const StepSkeleton = memo(() => <div className="min-h-[60vh] md:min-h-screen flex items-center justify-center py-12 px-4">
...
const HowItWorks = () => {
  ...
  return <>
      <Helmet>
        ...
        <meta name="description" content="Set up PayTap in minutes. Track spending, set limits, and manage tags, vehicles, or teams — all from one app." />
      </Helmet>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main>
          ...
          <section className="pt-24 pb-8 text-center px-4">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground text-center">Let's help you 
step by step</h1>
          </section>
