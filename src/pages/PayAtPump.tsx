  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="No cards, no cash, no delay. Pay for fuel with a single tap of your Paytap NFC tag. Works at 8L+ terminals across India. ₹499 one-time." />
